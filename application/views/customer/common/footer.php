<footer class="page-footer font-small indigo">
        ...
        <div class="row text-center d-flex justify-content-center pt-5 mb-3">
            ...
            <div class="col-md-2 mb-3">
                <h6 class="text-uppercase font-weight-bold">
                  <a href="localhost/gameon7/pages/1">contact-us</a>
                </h6>
            </div>
            
            <div class="col-md-2 mb-3">
                <h6 class="text-uppercase font-weight-bold">
                  <a href="localhost/gameon7/pages/2">frequently-asked-questions</a>
                </h6>
            </div>
            
            <div class="col-md-2 mb-3">
                <h6 class="text-uppercase font-weight-bold">
                  <a href="localhost/gameon7/pages/3">terms-of-services</a>
                </h6>
            </div>
            <!-- Grid column -->
        </div>
    ...
    <!-- <script type="text/javascript" src="<?php //echo base_url(); ?>/assets/js/vue-resource.js"></script> -->
    <!-- <script type="text/javascript" src="<?php //echo base_url(); ?>/assets/js/vee-validate.js"></script> -->
    ...
    <!-- <script type="text/javascript" src="<?php //echo base_url(); ?>/assets/js/loginJquery.js"></script> -->
    ...
    <!-- Custom VueJs -->
    <!-- <script type="text/javascript" src="<?php //echo base_url(); ?>/assets/js/commonVuegameon7.js"></script> -->
    <!-- <script type="text/javascript" src="<?php //echo base_url(); ?>/assets/js/loginVue.js"></script> -->
    <!-- <script type="text/javascript" src="<?php //echo base_url(); ?>/assets/js/sportListVueGameon7.js"></script> -->
    <!-- Custom VueJs -->
</footer>
</body>
</html>