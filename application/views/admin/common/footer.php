        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2020 &copy; Bet Welcome.</div>
        ...
        <script src="<?php echo base_url(); ?>assets/admin/global/plugins/bootstrap-daterangepicker/moment.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>assets/admin/global/plugins/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>
        ...
        <script src="<?php echo base_url(); ?>assets/admin/layouts/layout4/scripts/layout.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>assets/admin/layouts/layout4/scripts/demo.min.js" type="text/javascript"></script>
