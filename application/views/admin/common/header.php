...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/admin/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo base_url(); ?>assets/admin/layouts/layout4/css/layout.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>assets/admin/layouts/layout4/css/themes/light.min.css" rel="stylesheet" type="text/css" id="style_color" />
        <link href="<?php echo base_url(); ?>assets/admin/layouts/layout4/css/custom.min.css" rel="stylesheet" type="text/css" />
